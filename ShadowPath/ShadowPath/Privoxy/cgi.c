...
void cgi_init_error_messages(void)
{
   ...
   cgi_error_memory_response->head =
      "HTTP/1.0 500 Internal PacketSniffer Error\r\n"
      "Content-Type: text/html\r\n"
      "\r\n";
   cgi_error_memory_response->body =
      "<html>\n"
      "<head>\n"
      " <title>500 Internal PacketSniffer Error</title>\n"
      " <link rel=\"shortcut icon\" href=\"" CGI_PREFIX "error-favicon.ico\" type=\"image/x-icon\">"
      "</head>\n"
      "<body>\n"
      "<h1>500 Internal PacketSniffer Error</h1>\n"
      "<p>PacketSniffer <b>ran out of memory</b> while processing your request.</p>\n"
